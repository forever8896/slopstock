...
- [ ] Walrus storage impl + amnesia demo — [03](03-walrus.md) + [12](../superpowers/plans/2026-06-13-walrus-stateless-operator.md) · *storage impl + AES + snapshot/restore + receipt pinning ✅; Seal cipher + ENS pointer + receipt fold-in ✅ (plan 12 A–C); live amnesia-demo run (plan 12 Phase D/F) + web tape remain*
